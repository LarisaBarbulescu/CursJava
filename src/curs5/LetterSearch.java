...
public class LetterSearch {
	...
	public static void main(String[] args) {
		...
		String text =  scan.next().toLowerCase();   //toLowerCase() - transforma din litera mare in litera mica
		...
		for(int i = 0; i < text.length(); i++ ) {
			...
			if(text.charAt(i) == 'b' || text.charAt(i) == 'B') {  //cauta caracterul de la pozitia i chiar daca "text" este un string
				//amGasitLiteraB = true;
				//break;
				nrAparitii++;
			}
