...
public class CalculImpozitTotal {
	...
	final static int PRAG_VENIT = 50000;  //final - constanta si se scrie cu caps
	...
	public static void main(String[] args) {
		...
		for(int i = 1; i<= numarVenituri; i++) {
			...
			double venit = scan.nextDouble();   //numericul cu virgula =float(arata pana la 15 caractere dupa virgula), iar double arata pana la 2
